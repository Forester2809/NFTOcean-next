...
import MarketplaceTwoHeader from "../components/Marketplace/MarketplaceTwo/MPTTwoHeader"
import MPTGridItem from "../components/Marketplace/MarketplaceTwo/MPTGridItem"

const MarketplaceTwo=()=>{
return(
<>
<HeaderTwo/>
<BreadCrumbOne pagename="Marketplace" prevPage="Home"/>
<div className="marketplace_style_one bg-body-2 section_gap_y_bottom__1 overflow-hidden">
<div className="container">

 <MarketplaceTwoHeader/>

<div className="row row-cols-lg-4 row-cols-sm-2 row-cols-1 pt-40">
