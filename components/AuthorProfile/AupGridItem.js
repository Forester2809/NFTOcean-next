...
<div className="auction_card_style__two">
    ...
    <div className="nft__disc">
        ...
        <a className="nft__creator">{props.username} <img
                src="/images/icons/tick-blue.svg" alt=""/>
        </a>
        </Link>
        ...
        <div className="nft__title">
            ...
            <ins className="current-price">
                <img
                    src="/images/icons/tri-flash-blue.svg" alt=""/> 
                    <span>{props.price}</span></ins>
        </div>
        ...
        <div className="nft__bottom">
            ...
            <div className="nft__countdown"><div className="count__down countdown" data-date="2022-08-13">
            </div></div>
        </div>
    </div>
