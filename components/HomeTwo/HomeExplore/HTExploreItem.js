...
<div className="col pt-3">
    <div className="auction_card_style__two">
        ...
        <div className="nft__disc">
            ...
            <a className="nft__creator">{props.username} 
            ...
            <div className="nft__title">
                ...
                <img src="/images/icons/tri-flash-blue.svg" alt=""/> <span>{props.price} ETH</span></ins>
            </div>
            ...
            <div className="nft__bottom">
                ...
                <div className="nft__countdown"><div className="count__down countdown" data-date="2022-08-09">
