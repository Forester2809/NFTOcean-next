...
<ul className="filter-list d-flex flex-wrap gap-2">
    <li className="single-filter mt-0">
        <button 
        onClick={e=>CurrentFilter==='flow'?setCurrentFilter(''):setCurrentFilter('flow')}
        ...
        <div className={`custom__dropdown style__one ${CurrentFilter==='flow'?'dropdown-active':''}`}>
            <ul>
                <li className="dropdown__item">
                    <input type="radio" id="flw1" name="flwBox" checked
    ...
    <li className="single-filter mt-0">
        ...
        onClick={e=>CurrentFilter==='category'?setCurrentFilter(''):setCurrentFilter('category')}
        >  
        <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`custom__dropdown style__one ${CurrentFilter==='category'?'dropdown-active':''} `}>
                <ul>
                    <li className="dropdown__item">
                        <input type="radio" id="cate1" name="cateBox" checked/>
                        <label htmlFor="cate1">
                    ...
                    <li className="dropdown__item">
                        ...
                        <label htmlFor="cate2">
                            <img src="/images/icons/art-color.svg" alt=""/> Art</label>
                    </li>
                    <li className="dropdown__item">
    ...
    <li className="single-filter mt-0">
        <button className="has__dropdown"
        onClick={e=>CurrentFilter==='collection'?setCurrentFilter(''):setCurrentFilter('collection')}
        >  <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={`custom__dropdown style__one ${CurrentFilter==='collection'?'dropdown-active':''}`}>
                <ul>
                    <li className="dropdown__item">
                        <input type="radio" id="coll1" name="collBox" checked/>
    ...
    <li className="single-filter mt-0">
        <button className="has__dropdown"
        onClick={e=>CurrentFilter==='price'?setCurrentFilter(''):setCurrentFilter('price')}
        > <svg width="10" height="15" viewBox="0 0 10 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            </svg><span>Price range</span></button>

            <div className={`custom__dropdown style__one ${CurrentFilter==='price'?'dropdown-active':''} `}>
                <ul>
                    <li className="dropdown__item">
                    ...
                    <li className="dropdown__item">
                        <input type="radio" id="price5" name="priceBox" checked/>
...
export default MarketplaceTwoHeader