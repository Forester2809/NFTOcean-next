...
const MPTGridItem=(props)=>{
return(
<div className="col pt-lg-0 py-4">
    ...
    <div className="nft__disc">
        ...
        <div className="nft__title">
            ...
            <ins className="current-price">
                <img src="/images/icons/tri-flash-blue.svg" alt=""/> <span>{props.price}</span></ins>
        </div>
        ...
        <div className="nft__bottom">
            ...
            <div className="nft__countdown"><div className="count__down countdown" data-date="2022-11-09">
            </div></div>
        </div>
    </div>
