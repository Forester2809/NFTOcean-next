...
<header ref={navRef}>
<div className={`header-area header-defult header_style__three bg-body ${isVisible?'':'sticky'} `}>
<div className="container">
        ...
        <div className="col-xl-4 col-2 col-lg-3 col-md-2 col-2 align-items-center d-flex order-0">
            <div className="nav-logo logo-switch d-flex justify-content-between align-items-center">
                ...
                <a className="logo-dark">
                    <img src={HeaderConstant.LogoDark} alt="logo"/>
                </a>
                </Link>
                <Link href="/">
                <a className="logo-light">
                    <img src={HeaderConstant.LogoLight} alt="logo"/>
                </a>
                </Link>
            </div>
            <div className="nav-search-style-three w-100 d-xl-block d-none">
        ...
        <div className="col-xl-8 col-10 col-lg-9 d-flex justify-content-end">
            <nav className={`main-nav mr-2 ${MobileMenu?'slidenav':''}`}>
                ...
                <ul>
                    ...
                    <li className="has-child-menu">
                        ...
                        >
                            ...
                            <li><Link href="/nft-details"><a>NFT Details</a></Link></li>
                    ...
                    <li className="has-child-menu">
                        ...
                        >
                            ...
                            <li><Link href="/careate-multiple-nft"><a>Create NFT (Maltiple)</a></Link></li>
                ...
                <div className="d-xl-none d-inline-flex flex-column gap-3 px-3 mt-4">
                    ...
                    <a className="nav-three-btn"><span>Connect Wallet</span></a>
                    </Link>
                </div>
            </nav>
            ...
            <div className="nav-actions d-flex align-items-center">
                ...
                <div className="d-flex align-items-center gap-4 ml-2">
                    <div className="mobile-menu d-flex ">
                        ...
                        className={`hamburger d-block d-xl-none ${MobileMenu?'h-active':''} `}>
