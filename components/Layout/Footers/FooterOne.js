...
return(
<div className={`footer_style__one ${!props.white?'varient-2':''} bg-body ${props.borderTop?'has-stork':''} section_gap_y_top__1`}>
...
<div className="row gy-4">
    <div className="col-lg-3">
        <div className="footer__about">
            ...
            <h5>Language</h5>
            <div className={`languege__dropdown ${!props.white?'varient-2':''}`}>
                <button>
    ...
    <div className="col-lg-2 col-6 d-flex justify-content-lg-center ">
        <div className="footer__widget">
            ...
            <ul className="footer_widget__links">
                <li><Link href="/create-single-nft"><a>Upload</a></Link></li>
    ...
    <div className="col-lg-4">
        <div className="footer__widget newslatter__widget">
            ...
            <ul className={`footer_social__links d-flex ${props.white?'style__two':''}`}>
...
<div className="row footer__copyright">
    <div className="col-lg-12">
        <p className="text-center">Copyright©2022. Created with love by <a>wprealizer</a></p>
    </div>
</div>
</div>
</div>
